...
plt.plot(time[N-1:-1], move_mean[N-1:-1], 'r', label = "moving average over " + str(N) + " ps")
...
plt.fill_between(time[N-1:-1], dist_upper_bound[N-1:-1], dist_lower_bound[N-1:-1], alpha = 0.4, label = "error band")
